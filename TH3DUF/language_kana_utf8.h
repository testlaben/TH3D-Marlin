...
#define MSG_DEBUG_MENU                      _UxGT("デ�?ッグメニュー")                // "Debug Menu"
#define MSG_PROGRESS_BAR_TEST               _UxGT("プログレス�?ー テスト")            // "Progress Bar Test"
...
#define MSG_LEVEL_BED_HOMING                _UxGT("ゲンテンフッキ�?ュウ")              // "Homing XYZ"
...
#define MSG_PREHEAT_1                       _UxGT("PLA ヨ�?ツ")                   // "Preheat PLA"
#define MSG_PREHEAT_1_N                     MSG_PREHEAT_1 _UxGT(" ")
#define MSG_PREHEAT_1_ALL                   _UxGT("PLA スベテヨ�?ツ")              // " All"
#define MSG_PREHEAT_1_BEDONLY               _UxGT("PLA ベッドヨ�?ツ")              // " Bed"
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1 _UxGT("セッテイ")       // " conf"
#define MSG_PREHEAT_2                       _UxGT("ABS ヨ�?ツ")                  // "Preheat ABS"
#define MSG_PREHEAT_2_N                     MSG_PREHEAT_2 _UxGT(" ")
#define MSG_PREHEAT_2_ALL                   _UxGT("ABS スベテヨ�?ツ")              // " All"
#define MSG_PREHEAT_2_BEDONLY               _UxGT("ABS ベッドヨ�?ツ")              // " Bed"
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT("セッテイ")       // " conf"
#define MSG_COOLDOWN                        _UxGT("カ�?ツテイシ")                  // "Cooldown"
...
#define MSG_MOVING                          _UxGT("イドウ�?ュウ")                   // "Moving..."
...
#define MSG_FILAMENT_DIAM                   _UxGT("フィラメント�?ョッケイ")            // "Fil. Dia."
...
#define MSG_TUNE                            _UxGT("�?ョウセイ")                    // "Tune"
#define MSG_PAUSE_PRINT                     _UxGT("イ�?ジテイシ")                  // "Pause print"
...
#define MSG_USERWAIT                        _UxGT("シ�?ラクオマ�?クダサイ")           // "Wait for user..."
#define MSG_RESUMING                        _UxGT("プリントサイカイ")                // "Resuming print"
#define MSG_PRINT_ABORTED                   _UxGT("プリントガ�?ュウシサレマシタ")       // "Print aborted"
...
#define MSG_ENDSTOP_ABORT                   _UxGT("イドウゲンカイケン�?キノウ")         // "Endstop abort"
#define MSG_HEATING_FAILED_LCD              _UxGT("カ�?ツシッパイ")                 // "Heating failed"
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("エラー:ジョウ�?ョウサーミスターキノウ")  // "Err: REDUNDANT TEMP"
#define MSG_THERMAL_RUNAWAY                 _UxGT("�?ツボウソウ")                   // "THERMAL RUNAWAY"
#define MSG_ERR_MAXTEMP                     _UxGT("エラー:サイコウオン�?ョウカ")         // "Err: MAXTEMP"
#define MSG_ERR_MINTEMP                     _UxGT("エラー:サイテイオンミマン")          // "Err: MINTEMP"
#define MSG_ERR_MAXTEMP_BED                 _UxGT("エラー:ベッド サイコウオン�?ョウカ")    // "Err: MAXTEMP BED"
...
#define MSG_HALTED                          _UxGT("プリンター�?テイシシマシタ")         // "PRINTER HALTED"
#define MSG_PLEASE_RESET                    _UxGT("リセットシテクダサイ")              // "Please reset"
#define MSG_SHORT_DAY                       _UxGT("d")                          // One character only
#define MSG_SHORT_HOUR                      _UxGT("h")                          // One character only
#define MSG_SHORT_MINUTE                    _UxGT("m")                          // One character only
#define MSG_HEATING                         _UxGT("カ�?ツ�?ュウ")                   // "Heating..."
#define MSG_HEATING_COMPLETE                _UxGT("カ�?ツカンリョウ")                 // "Heating done."
#define MSG_BED_HEATING                     _UxGT("ベッド カ�?ツ�?ュウ")              // "Bed Heating."
#define MSG_BED_DONE                        _UxGT("ベッド カ�?ツカンリョウ")            // "Bed done."
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("�?ュウシン コウセイ")              // "Calibrate Center"
...
#define MSG_INFO_PRINT_LONGEST              _UxGT("サイ�?ョウプリントジカン")           // "Longest job time"
...
#define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("シ�?ラクオマ�?クダサイ")            // "of the filament"
#define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("フィラメントヌキダシ�?ュウ")          // "Wait for"
#define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("シ�?ラクオマ�?クダサイ")            // "filament unload"
...
#define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("フィラメントソウテン�?ュウ")          // "Wait for"
#define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("シ�?ラクオマ�?クダサイ")            // "filament load"
#define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("フィラメントオシダシ�?ュウ")          // "Wait for"
#define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("シ�?ラクオマ�?クダサイ")            // "filament extrude"
#define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("プリントヲサイカイシマス")           // "Wait for print"
#define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("シ�?ラクオマ�?クダサイ")            // "to resume"
