...
#define MSG_SET_ORIGIN                      _UxGT("Nastavit po�?átek")
...
#define MSG_EXTRUDE                         _UxGT("Vytla�?it (extr.)")
#define MSG_RETRACT                         _UxGT("Zatla�?it (retr.)")
...
#define MSG_UBL_UNHOMED                     _UxGT("Přeje�?te domů")
...
#define MSG_UBL_CONTINUE_MESH               _UxGT("Pokra�?ovat v síťi")
...
#define MSG_UBL_MANUAL_FILLIN               _UxGT("Ru�?ní hustota")
...
#define MSG_UBL_LOAD_MESH                   _UxGT("Na�?íst síť bodů")
#define MSG_UBL_SAVE_MESH                   _UxGT("Uložit síť bodů")
#define MSG_MESH_LOADED                     _UxGT("Síť %i na�?tena")
...
#define MSG_LOAD_EEPROM                     _UxGT("Na�?íst nastavení")
...
#define MSG_INIT_SDCARD                     _UxGT("Na�?íst SD kartu")
...
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z ZAK�?Z�?NO")
#define MSG_HALTED                          _UxGT("TISK. ZASTAVENA")
#define MSG_PLEASE_RESET                    _UxGT("Prove�?te reset")
...
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Jas světla")
...
#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Po�?et tisků")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Dokon�?eno")
  #define MSG_INFO_PRINT_TIME               _UxGT("Celkový �?as")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Nejdelší tisk")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Celkem vytla�?eno")
#else
  ...
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Vytla�?eno")
#endif
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ještě vytla�?it")
...
#define MSG_ERR_PROBING_FAILED              _UxGT("Kalibrace selhala")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("tla�?ítko...")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("na vytla�?ení")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_3       _UxGT("filamentu")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Čekejte prosím")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("na pokra�?ování")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Vytla�?ování...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Pokra�?ování...")
#endif // LCD_HEIGHT < 4
