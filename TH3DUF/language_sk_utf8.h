...
#define MSG_SET_ORIGIN                      _UxGT("Nastaviť za�?iatok")
...
#define MSG_EXTRUDE                         _UxGT("Vytla�?iť (extr.)")
...
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Presun na �?alší")
...
#define MSG_UBL_CONTINUE_MESH               _UxGT("Pokra�?ovať v sieti")
...
#define MSG_UBL_MANUAL_FILLIN               _UxGT("Ru�?ná hustota")
...
#define MSG_UBL_LOAD_MESH                   _UxGT("Na�?ítať sieť bodov")
...
#define MSG_LOAD_EEPROM                     _UxGT("Na�?ítať nastaveníe")
...
#define MSG_PREPARE                         _UxGT("Príprava tla�?e")
#define MSG_TUNE                            _UxGT("Doladenie tla�?e")
#define MSG_PAUSE_PRINT                     _UxGT("Pozastaviť tla�?")
#define MSG_RESUME_PRINT                    _UxGT("Obnoviť tla�?")
#define MSG_STOP_PRINT                      _UxGT("Zastaviť tla�?")
#define MSG_CARD_MENU                       _UxGT("Tla�?iť z SD")
#define MSG_NO_CARD                         _UxGT("Žiadna SD karta")
#define MSG_DWELL                           _UxGT("Spím...")
#define MSG_USERWAIT                        _UxGT("Čakám...")
#define MSG_PRINT_PAUSED                    _UxGT("Tla�? pozastavená")
#define MSG_RESUMING                        _UxGT("Obnovovanie tla�?e")
#define MSG_PRINT_ABORTED                   _UxGT("Tla�? zrušená")
...
#define MSG_INIT_SDCARD                     _UxGT("Na�?ítať SD kartu")
...
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z ZAK�?ZANÉ")
#define MSG_HALTED                          _UxGT("TLAČ. ZASTAVEN�?")
...
#define MSG_INFO_MENU                       _UxGT("O tla�?iarni")
#define MSG_INFO_PRINTER_MENU               _UxGT("Info o tla�?iarni")
...
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Jas svetla")
...
#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Po�?et tla�?í")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Dokon�?ené")
  #define MSG_INFO_PRINT_TIME               _UxGT("Celkový �?as")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najdlhšia tla�?")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Celkom vytla�?ené")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Tla�?e")
  ...
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Vytla�?ené")
#endif
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ešte vytla�?iť")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Obnoviť tla�?")
...
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Tryska: ")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("a stla�?te")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("tla�?idlo...")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("na vytla�?enie")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_3       _UxGT("filamentu")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Čakajte prosím")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("na pokra�?ovanie")
  #define MSG_FILAMENT_CHANGE_RESUME_3        _UxGT("tla�?e")
#else // LCD_HEIGHT < 4
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Vytla�?ovanie...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Pokra�?ovanie...")
#endif // LCD_HEIGHT < 4
